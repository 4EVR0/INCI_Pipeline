...
def parse_result_item(item: Dict[str, Any]) -> Dict[str, Any]:
    ...
    row = {
        ...
        "common_ingredient_name": first_or_none(
            metadata.get("nameOfCommonIngredientsGlossary")
        ),
        ...
        "classification_information": first_or_none(
        ...
        "corporate_search_version": first_or_none(
            metadata.get("corporate-search-version")
        ),
